...
export const Cart = ({ isOpen, onClose }: CartProps) => {
  // 1. Leemos el estado reactivo del mapa de items
  const $cartItems = useStore(cartItems);
  
  // 2. Transformamos el mapa (objeto) a un array para poder recorrerlo con .map()
              ...
              {items.map(item => (
                <div key={item.id} className="flex items-center gap-4 pb-4 border-b">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-primary-500 font-bold text-lg mb-2">
        ...
        {items.length > 0 && (
          <div className="border-t bg-white p-4 space-y-4">
            ...
            <button
              ...
              className="w-full bg-green-500 hover:bg-green-600 text-white font-bold py-4 px-6 rounded-lg flex items-center justify-center gap-3 transition-colors shadow-lg"
            >
